...
class main_fn:
    def front(self):
        ...
        Label(root,text='Name : GAURAV SINGH PARIHAR',fg='blue2',font="Arial 11 bold",pady=25).pack()

        Label(root,text='Er : 221B164',fg='blue2',font="Arial 11 bold",pady=25).pack()

        Label(root,text='Mobile : 62xxxxxxxx ',fg='blue2',font="Arial 11 bold",pady=25).pack()
    ...
    def loginn(self):
        ...
        Button(Frame2,text='Login',command=login).grid(row=4,column=1,pady=30)
                   
        #Button(Frame2,image='home',command=home).grid(row=5,column=1)
    ...
    def operator(self):
        ...
        def edit():
            ...
            if(oid.get()==""):
                ...
                try:
                    int(address.get())
                    showerror('Invalid Address','Address cannot be numbers only\nPlease try again')
                    address.delete(0,END)
                    return
                except:
                    m=0
